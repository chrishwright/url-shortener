 ...
 * it needs to be ran from the terminal using mvn clean install, or mvn verify.  It takes a bit
 * longer to startup as it uses Docker to spin up an instance of Cassandra for running the full
 * application context.
 */
@SpringBootTest
